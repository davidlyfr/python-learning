...
class Scene(object):
    ...
    def enter(self):
        print "This scene is not yet cnfigured. Subclass it and implement enter()."
        exit(1)
...
class Death(Scene):
    quips = [
        "You died. Tou kinda suck at this game.",
        "Your mom would be proud...a proud laugher",
        "I know many better that this."
    ]
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot":
            ...
            print "band your large head on the metal wall and pass out."
            ...
            print "Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvggf nebhaq gur ubhfr."
