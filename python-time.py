...
def one_hour():
    print "starting time\n"
    time_call = datetime.now() + timedelta(hours=1)
    print "time_call"

print "Starting Script\n"
print one_hour
#print "\ntime now %d, %r" % (one_hour, one_hour)

time_call2 = datetime.now() + timedelta(hours=1)
print time_call2

print "\ntime now  %r" % (time_call2)

#new_format = '{%Y-%m-%d %H:%M:%S}'.format(time_call2)
